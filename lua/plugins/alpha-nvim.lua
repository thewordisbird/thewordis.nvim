return {
  ...
  config = function()
    ...
    --   [[  _____|     |____|     |                                                                    |     |     |           |     |                               |      |          ]],
    --   [[ |                |     |                                                                    |     |_____|           |     |                               |      |          ]],
    --   [[ |_____       ____|     |_____   _________  _____ _____ _____  __________  __________  ______|     |_____  __________|     |_____         __________  _____|      |          ]],
    --   [[       |     |    |           \ /         \|     |     |     |/          \/          \/            |     |/          |           \   V   /          \/            |          ]],
    --   [[       |     |    |            |     ===   |     |     |     |            |           |            |     |    _______|            | <o)  |           |            |          ]],
    --   [[       |     |    |     ||     |           |     |     |     |     ||     |     |_____|     ||     |     |           |     ||     |(\\_//|     |_____|     ||     |          ]],
    --   [[       |     \____|     ||     |     ______|     |     |     |     ||     |     |     |     ||     |     |_______    |     ||     |(_\_/ |     |     |     ||     |          ]],
    --   [[       |          |     ||     |           |\               /|            |     |     |            |     |           |            |   |  |     |     |            |          ]],
    --   [[        \_________|_____||_____|\__________/ \_____________/  \___________/_____|      \___________|_____|\_________/ \__________/   _|_ |_____|      \___________|          ]],
    --   [[                                                                                                                                                                             ]],
    --
    -- }
